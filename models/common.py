...
from yolov5_dg.utils.dataloaders import exif_transpose, letterbox
...
from yolov5_dg.utils.plots import Annotator, colors, save_one_box
from yolov5_dg.utils.torch_utils import copy_attr, time_sync
...
class C3x(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, act=True):
        ...
        c_ = int(c2 * e)
        self.m = nn.Sequential(
            *(CrossConv(c_, c_, 3, 1, g, 1.0, shortcut, act=act) for _ in range(n))
        )
